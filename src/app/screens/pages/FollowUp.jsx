    ...
    <>
      <div>
        ...
        <div className="flex w-full flex-col md:flex-row items-start justify-between">
          <div className="flex w-full md:w-1/2 items-center flex-col gap-4 p-5">
            <img
              className="sm:w-[15rem] w-full"
              src="https://followup.helium10.com/static/media/follow-up-landing.c740e3b7f39d35f57b6d.png"
              alt=""
            />
            <p className="text-dark-blue text-2xl">Welcome to Follow-Up</p>
            <p className="text-gray-500 text-center w-full md:w-[22rem]">
              This fully automated, customizable, and Amazon-friendly email tool
          ...
          <div className="flex w-full md:w-1/2 items-center flex-col gap-4 p-5">
            <img className="w-full"
              src="https://followup.helium10.com/static/media/follow-up-landing-skelet.482e01c0647ef89016d0.png"
              alt=""
            />
          </div>
        </div>
